...
class EntryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Entry entity")
        ...
        .repeat(2) {
            ...
            .post("/api/entries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "entrydate":"2020-01-01T00:00:00.000Z", "candidatename":"SAMPLE_TEXT", "major":"SAMPLE_TEXT", "pool":"SAMPLE_TEXT", "school":"SAMPLE_TEXT", "graduation":"2020-01-01T00:00:00.000Z", "availability":"SAMPLE_TEXT", "recruiter":null, "information":null}""")).asJSON
            .check(status.is(201))
